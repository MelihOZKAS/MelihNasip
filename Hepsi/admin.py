...
class HepsiAdmin(admin.ModelAdmin):
    list_display = ("title","Model", "youtube" ,"okunma_sayisi","seo_check","status","kelime_sayisi","get_hikayeKategorisi", "get_masalKategorisi","yayin_tarihi","olusturma_tarihi" ,"guncelleme_tarihi","small_banner","banner","aktif",)#"get_hikayeKategorisi", "get_masalKategorisi",
